namespace Stash
{
    public static class Consts
    {
        ...
        public const string SceneQuery = @"query{{findScene(id:{0}){{id,title,details,date,rating100,paths{{screenshot}}studio{{name,parent_studio{{name,image_path}},image_path}}tags{{name}}performers{{id,name,disambiguation,image_path}}}}}}";
